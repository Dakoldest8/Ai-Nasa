# ⚠️ Be More Agent — Hailo-10H Edition [REFERENCE FORK - NOT PROJECT TARGET]

> **NOTE**: This is a reference fork optimized for Hailo-10H NPU hardware. The **main this project uses `be-more-agent-main/`** (Ollama-based) instead.
> 
> This folder is kept for **reference/research only**. Do not use for development unless you have Hailo-10H hardware.
> 
> Instead, use: [be-more-agent-main/](../be-more-agent-main/)
