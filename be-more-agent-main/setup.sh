...
echo -e "${YELLOW}[5/7] Installing Whisper.cpp...${NC}"
...
if [ ! -f "whisper.cpp/models/ggml-base.en.bin" ]; then
    wget -O whisper.cpp/models/ggml-base.en.bin https://huggingface.co/ggerganov/whisper.cpp/resolve/main/ggml-base.en.bin
fi
...
echo -e "${GREEN}✨ Setup Complete! Run './start_agent.sh' or './start_web.sh'${NC}"
